							...
							<div class="member-wrapper">
								...
								<div class="member-detail">
									...
									<ul class="info-list">
										{{--
										<li>
											<strong>Address:</strong>24058, Belgium, Brussels, Liutte 27, BE</li>
										<li>
						...
						<div class="staff-tabs">
							<div class="staff-tabs-selectors">
								<ul class="tabs">
									{{--
									<li class="tab">
										<a class="" href="#professionalSkill">
											<i class="fa fa-pie-chart"></i> Professional Skills</a>
									</li> --}}
									<li class="tab">
										<a class="active" href="#aboutme">
											<i class="fa fa-user"></i> About Me</a>
									</li>
									{{--
									<li class="tab">
										<a href="#availablity">
											<i class="fa fa-calendar-o"></i> Availablity Calendar</a>
									</li> --}}
								</ul>
							</div>
							<div class="staff-tab-content">
								...
								<div id="professionalSkill">
									<div class="row">
										<div class="col s12 m6 l6">
											<div class="staff-tab-content">
												Duis sed odio sit amet nibh vulate cursus sit amet mauris.Morbi accumsan psum velit. Nam nec tellus a odio tincidunt auctor
												a ornare odio. Sed no mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent
												per conubia nostra,
											</div>
										</div>
										<div class="col s12 m6 l6">
												...
												<div class="staff-tab-content" style="box-shadow: -1px 2px 24px 0px rgba(127,127,127,1);color: #7F8080;">
													...
													<div class="panel-header" style="text-align: center; color: cornflowerblue;">
														...
														<p>
															...
															New Patient: {{ $chamber->new_patient }}.tk
															<br>
															<i class="fa fa-refresh" aria-hidden="true"></i>
															Returning Patient: {{ $chamber->returning_patient }}.tk
															<br>
								...
								{{--
								<div id="availablity">
									<p>Duis sed odio sit amet nibh vulate cursus sit amet mauris.Morbi accumsan psum velit. Nam nec tellus a odio tincidunt
										auctor a ornare odio. Sed no mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora
										torquent per conubia nostra, per inceptos himenaeos. Mauris ine rat justo. Nullam ac urna eu felis dapibus condimentum
										sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra,
...
@section('jslink')
	<script src="http://maps.google.com/maps/api/js?key=AIzaSyAsBE16CUMhihku7nqBldifkvXBO26ksDQ&sensor=false" type="text/javascript"></script>
	<!-- Swiper JS -->
