          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">All Posts</h5>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <a href="{{ route('post.create') }}" class="btn teal waves-effect waves-light">Add New</a>
              <div class="row">
                <div class="col s12">
                 <div class="container">
                    ...
                    <tbody>
                      @foreach ($posts as $post)
                        <tr>                                                
                            ...
                            <td class="center"><a href="{{ route('post.edit',$post->id) }}" class="btn-floating waves-effect waves-light purple"><i class="mdi-editor-mode-edit"></i></a>||
